...
<html lang="es" dir="ltr">
  <head>
    ...
    <title>Desarrollador Web Full Stack | Bryan David</title>
  ...
  <body>
    ...
    <a id="whatsapp" href="https://api.whatsapp.com/send?phone=7225667014"><img src="imagenes/whatsapp.png" alt=""></a>
    ...
    <header>
        <div class="menu">
          <div class="contenedor">
            <p class="logo">BRYAN DAVID VIDAL</p>
            <img class="menu-icon" src="imagenes/menu.png" alt="">
            <nav>
              <ul class="lista-menu">
                <li><a href="#sobre-mi">Sobre mí</a></li>
                <li><a href="#servicios">Servicios</a></li>
                <li><a href="#mis-trabajos">Mís trabajos</a></li>
                <li><a href="#porque-trabajar">¿Por qué trabajar conmigo?</a></li>
        ...
        <div class="contenedor" id="contenedor-titulo-flex">
          <div class="contenedor-titulo">
            <h1>Bryan David Vidal</h1>
            <h2>Diseñador & Desarrollador Web</h2>
            <a href="#"><b>VER MIS TRABAJOS</b></a>
          </div>
        </div>
    </header>
    ...
    <main>
      <section id="sobre-mi">
        <div class="contenedor">
          ...
          <div class="contenedor-sobremi">
            ...
            <div class="texto">
              <p>Mi nombre es Bryan David Vidal y soy diseñador de paginas web. Tengo la experiencia en desarrollo de sitios web para pequeñas y medianas empresas, e incluso desarrollo de tiendas e-commerce.</p>
              <p>Me aseguro de utilizar siempre las últimas tecnologías de desarrollo web: HTML5, CSS3, jQuery, JavaScript, Ajax. Si nececitas una página web moderna, funcional, responsive(adaptable a cualquier dispositivo) te aseguro que llegaste al lugar correcto.</p>
      ...
      <section id="que-esperas">
        <div class="contenedor">
          <h3>¿Qué esperas para tener tú pagina web?</h3>
            <a href="">CHARLEMOS</a>
        </div>
      </section>
      ...
      <section id="contacto">
        ...
        <div class="contenedor">
          <h3>Contacto</h3>
          <form class="formulario" action="envioFormulario.php" method="post" enctype="multipart/form-data">
            ...
            <div class="contacto-info">
              <div class="mail">
                <img src="imagenes/mail-icon.png" alt="">
                <p>bryandavidvidal@gmail.com</p>
              </div>
              <div class="watsapp">
                <img src="imagenes/whatsapp-icon.png" alt="">
                <p>7225667014</p>
              </div>
            </div>
        </div>
    ...
    <footer>
        <div class="contenedor">
              <div class="redes-sociales">
                <a href="#"><img src="imagenes/facebook.png" alt="imagen-facebook"></a>
                <a href="#"><img src="imagenes/medium.png" alt="imagen-medium"></a>
                <a href="#"><img src="imagenes/github.png" alt="imagen-github"></a>
                <a href="#"><img src="imagenes/linkedin.png" alt="imagen-linkedin"></a>
              </div>
              <div class="parrafo">
                <p>© 2020 Bryan David Vidal | Diseñador Web México. Todos los derechos reservados</p>
              </div>
        </div>
    </footer>
    ...
    $(document).ready(function(){
      ...
      $(window).scroll(function(){
        ...
        if(scroll > 100){
          ...
          // Cuando el scroll esta hacia arriba
